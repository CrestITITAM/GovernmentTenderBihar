...
autoUpdater.on('update-downloaded', () => {
  notifier.notify(
    {
      title: 'ITAM Version 4.0.83 Released. Click to Restart Application.', //put version number of future release. not current.
